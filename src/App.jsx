...
function App(){
  ...
  const persist = async (confirmed=false) => {
    ...
    try {
      ...
      setForecastStatus(confirmed ? 'empty' : 'draft');
  ...
  return <div className="app-shell">
    ...
    <main className="content">
      ...
      {view==='pronostico' && <PredictionView matches={matches} predictions={predictions} activeGroup={activeGroup} setActiveGroup={setActiveGroup} setScore={setScore} persist={persist} canConfirm={canConfirm} saving={saving}/>} 
...
function PredictionView({matches,predictions,activeGroup,setActiveGroup,setScore,persist,canConfirm,saving}){
